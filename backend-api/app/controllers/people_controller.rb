class PeopleController < ApplicationController
  ...
  def destroy
    unless @person[:id] == 10
      render json: { message: "Nope. You can't delete #{@person[:name]}. \n Your syntax is correct though, \n but the person you are looking for saved over 300 slaves during a ten-year span." }
    else
  ...
  def update
    unless @person[:id] == 11
      render json: { message: "What are you updating me for? My info is all correct! Your syntax though? Flawless!" }
    else
